...
const i18n = {
    ...
    translations: {
        ru: {
            ...
            rewardedAdBtn: 'Получить награду',
            rewardAlreadyTaken: 'Награда получена',
            rewardBalance: 'Бонусы: {amount}',
            rewardReceived: 'Вы получили бонус: +{amount}!',
            rewardUnavailable: 'Реклама сейчас недоступна. Попробуйте позже.',
            rewardError: 'Не удалось показать рекламу. Попробуйте позже.',
        ...
        en: {
            ...
            rewardedAdBtn: 'Get reward',
            rewardAlreadyTaken: 'Reward received',
            rewardBalance: 'Rewards: {amount}',
            rewardReceived: 'You received a bonus: +{amount}!',
            rewardUnavailable: 'Ad is currently unavailable. Please try again later.',
            rewardError: 'Failed to show ad. Please try again later.',
